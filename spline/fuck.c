...
void main(){
  ...
  double* ws = (double *)malloc(sizeof(double) * 19);
  ...
  int n = 19;
  int nk = 21;
  double* coef = (double *)malloc(sizeof(double) * 21);
  double* sz = (double *)malloc(sizeof(double) * 21);
  double* lev = (double *)malloc(sizeof(double) * 19);
  double* knot = (double *)malloc(sizeof(double) * 25);
  ...
  int ldnk = 1;
  int ier = 1;
  double * out = (double *)malloc(sizeof(double) * 19);
  int order = 0;
sbart
    (&penalt, &dofoff,
     xs, ys, ws, &ssw,
